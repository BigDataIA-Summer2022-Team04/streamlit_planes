...
def app():
    ...
    url = "https://api.anandpiyush.com/planes_info_from_mfg_year"
    ...
    def result(n,year):
        ...
        header = {}
        token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhbmFuZC5waUBub3J0aGVhc3Rlcm4uZWR1IiwiZXhwIjoxNjU2NzI2OTk3fQ.pLkg9F6DMuqjpQHMcBXYxbl7wf_51vRPQ1UC7rOdW20'
        header['Authorization'] = f"Bearer {token}"
        response = requests.request("GET", url, headers=header)
        st.write('Your status_code:', response)
        st.write('Your status_code:', response.text)
        st.write('You selected:', year)
